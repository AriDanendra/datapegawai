  ...
  const handleSaveChanges = async (e) => {
    ...
    try {
      ...
      if (modalType === 'add') {
        ...
        showSuccessModal(`Data penghargaan berhasil diperbarui!`);
      }
      handleCloseModal();
    } catch (error) {
      console.error("Gagal menyimpan data penghargaan:", error.response ? error.response.data : error.message);
      ...
      return (
        <form onSubmit={handleSaveChanges}>
          ...
          <div className="modal-form-group">
            <label>Upload Sertifikat/Piagam (Opsional)</label>
